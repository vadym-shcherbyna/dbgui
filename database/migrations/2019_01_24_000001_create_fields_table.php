...
class CreateFieldsTable extends Migration
{
    ...
    public function up()
    {
        ...
        // Fields fields
        DB::table('fields')->insert(['table_id' => 2, 'field_type_id' => 7, 'name' => 'Weight', 'code' => 'weight', 'weight' => 120, 'flag_required' => 1, 'flag_view' => 1, 'default_value' => 100]);
        DB::table('fields')->insert(['table_id' => 2, 'field_type_id' => 6, 'name' => 'Table', 'code' => 'table_id', 'weight' => 110, 'flag_required' => 1, 'flag_filter' => 1, 'linked_table_id' => 1, 'flag_view' => 1, 'flag_edit' => 0]);
        DB::table('fields')->insert(['table_id' => 2, 'field_type_id' => 6, 'name' => 'Field type', 'code' => 'field_type_id', 'weight' => 100, 'flag_required' => 1, 'linked_table_id' => 3, 'flag_edit' => 0]);
        DB::table('fields')->insert(['table_id' => 2, 'field_type_id' => 6, 'name' => 'Linked table', 'code' => 'linked_table_id', 'weight' => 90, 'linked_table_id' => 1, 'flag_edit' => 0]);
