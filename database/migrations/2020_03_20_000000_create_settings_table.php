...
class CreateSettingsTable extends Migration
{
    ...
    public function up() {
        ...
        // Populate
        DB::table('settings')->insert(['name' => 'Show System Tables', 'code' => 'dev_mode_tables', 'value' => 1, 'type' => 'flag']);
        DB::table('settings')->insert(['name' => 'Show System Fields', 'code' => 'dev_mode_fields', 'value' => 1, 'type' => 'flag']);
