...
class CreateTablesTable extends Migration
{
    ...
    public function up() {
        ...
        DB::table('tables')->insert(['id' => 3, 'table_group_id' => 1, 'name' => 'Field types',  'code' => 'field_types', 'url' => 'field-types', 'weight' => 80, 'fa' => 'table', 'item_name' => 'type', 'flag_system' => 1]);
        ...
        DB::table('tables')->insert(['id' => 5, 'table_group_id' => 1, 'name' => 'Settings', 'code' => 'settings', 'url' => 'settings', 'weight' => 60, 'fa' => 'gear', 'item_name' => 'Setting', 'flag_system' => 1]);
        DB::table('tables')->insert(['id' => 6, 'table_group_id' => 2, 'name' => 'Users', 'code' => 'users', 'url' => 'users', 'weight' => 100, 'fa' => 'users', 'item_name' => 'user']);
        DB::table('tables')->insert(['id' => 7, 'table_group_id' => 2, 'name' => 'User groups', 'code' => 'user_groups', 'url' => 'user-groups', 'weight' => 90, 'fa' => 'user', 'item_name' => 'group', 'flag_system' => 1]);
